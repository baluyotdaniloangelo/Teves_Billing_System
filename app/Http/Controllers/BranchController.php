...
class BranchController extends Controller
{
	...
	public function branch_info(Request $request){
		...
		$data = BranchModel::find($branchID, ['branch_id', 'branch_code', 'branch_name', 'branch_tin', 'branch_address', 'branch_contact_number', 'branch_owner', 'branch_owner_title', 'branch_logo']);
	...
	public function create_branch_post(Request $request){
        ...
        [
			'branch_code.required' => 'Branch Name is required',
			'branch_name.required' => 'Address is Required',
			'branch_tin.required' => 'TIN is Required'
        ]
		);
