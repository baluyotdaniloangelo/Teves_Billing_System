...
class ReportController extends Controller
{
	...
	public function generate_report(Request $request){
		...
		$all_branches = $request->all_branches;	
			...
			$data = BillingTransactionModel::join('teves_product_table', function ($join) {
				...
				//->where('branch_idx', $company_header)
	...
	public function generate_receivable_covered_bill_pdf(Request $request){
        ...
        $pdf = PDF::loadView('printables.report_billing_receivable_pdf', compact('title_billing_statement', 'client_data', 'user_data', 'billing_data', 'start_date', 'end_date', 'less_per_liter', 'company_header', 'receivable_data','withholding_tax_percentage','net_value_percentage','vat_value_percentage','branch_header'));
	...
	public function generate_billing_soa_receivable_pdf(Request $request){
        ...
        $pdf = PDF::loadView('printables.report_billing_soa_receivable_pdf', compact('title_billing_statement','title_soa','title_receivable', 'client_data', 'user_data', 'billing_data', 'start_date', 'end_date', 'less_per_liter', 'company_header', 'receivable_data','withholding_tax_percentage','net_value_percentage','vat_value_percentage','branch_header','receivable_data','receivable_payment_data','amount_in_words'));
	...
	public function generate_sales_order_pdf(Request $request){
		...
		if($sales_order_data[0]['sales_order_quotation']==0){
			...
			$page = 'printables.report_sales_order_pdf_v3';
		}
		else{
			...
			if($sales_order_data[0]['sales_order_quotation_hide_volume']==1){
				/*hide volume*/
				$page = 'printables.report_sales_order_quotation_no_volume_pdf_v3';
			}else{
				/*show volume*/
				$page = 'printables.report_sales_order_quotation_show_volume_pdf_v3';
			}
	...
	public function generate_sales_order_qoutation_no_volume_pdf(Request $request){
		...
		$pdf = PDF::loadView('printables.report_sales_order_quotation_no_volume_pdf_v3', compact('title_sales_order', 'sales_order_data', 'user_data', 'amount_in_words', 'sales_order_component','branch_header'));
