...
class ProductSellingPriceController extends Controller
{
	...
	public function create_product_selling_price_post(Request $request){
        ...
        [
			...
			'client_idx.required' => 'supplier is required',
		...
		if($selling_price_id==0){
			...
			$ProductsellingPrice = new ProductPricePersellingModel();
			...
			$ProductsellingPriceHistory = new ProductPricePersellingHistoryModel();
			...
			$ProductsellingPrice = ProductPricePersellingModel::find($selling_price_id);
			$ProductsellingPrice->product_idx			= $request->product_idx;
			$ProductsellingPrice->client_idx 			= $request->client_idx;
			$ProductsellingPrice->selling_price 			= $request->selling_price;
			$ProductsellingPrice->branch_idx 			= $request->branch_idx;
	...
	public function product_price_per_selling_info(Request $request){
	...
	/*Delete Information*/
	public function delete_product_price_per_selling_info_confirmed(Request $request){

		$selling_price_id = $request->selling_price_id;
		ProductPricePersellingModel::find($selling_price_id)->delete();
		return 'Deleted';
