...
-- Dumping data for table teves_system.teves_billing_table: ~63 rows (approximately)
...
-- Dumping data for table teves_system.teves_receivable: ~10 rows (approximately)
INSERT INTO `teves_receivable` (`receivable_id`, `receivable_name`, `client_idx`, `control_number`, `billing_date`, `tin_number`, `or_number`, `payment_term`, `receivable_description`, `receivable_amount`, `created_at`, `updated_at`) VALUES
	(1, NULL, 1, '00000001', '2022-12-27', '0001', '000223', '1 month 11', 'Gasoline 12', 14040, '2022-12-17 23:06:55', '2022-12-25 21:40:38'),
	(11, NULL, 1, '00000002', '2022-12-25', NULL, 'SMPOR-0001', 'TERM 1', 'DESCRIPTION 1', 14040, '2022-12-25 19:13:16', '2022-12-25 19:13:16');
