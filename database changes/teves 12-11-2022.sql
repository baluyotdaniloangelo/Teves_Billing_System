...
INSERT INTO `teves_billing_table` (`billing_id`, `product_idx`, `drivers_name`, `plate_no`, `product_price`, `client_idx`, `order_quantity`, `order_total_amount`, `order_date`, `order_time`, `order_po_number`, `created_at`, `updated_at`) VALUES
	(1, 1, 'Juan dela tore', 'A-12345', 30, 1, 7.6, 228, '2022-12-05', '14:18', '123456', '2022-12-04 14:18:21', '2022-12-10 17:47:31'),
	(2, 1, 'Juan dela cruz', 'a-03853', 30, 1, 1, 30, '2022-12-06', '14:20', '93643', '2022-12-04 14:20:46', '2022-12-10 23:33:07'),
...
-- Dumping data for table teves_system.teves_client_table: ~2 rows (approximately)
