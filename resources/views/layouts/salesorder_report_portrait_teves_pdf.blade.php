...
<body>
	...
	<table class="" width="100%" cellspacing="0" cellpadding="1">
		...
		<tr>
			...
			<img src="{{public_path('client_logo/logo.jpg')}}" style="width:105px;">
			</td>
			<td nowrap style="font-size:16px; font-weight:bold;" align="center" colspan="5" width="55%">TEVES GASOLINE STATION</td>
		...
		<tr>
			<td nowrap style="font-size:12px;" align="center" colspan="5" width="55%">VAT REG. TIN : 740-213-285-001</td>
