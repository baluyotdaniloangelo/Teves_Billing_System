...
<script type="text/javascript">
	...
	function reload_report(receivable_id){
		...
		let LoadBillingHistoryData = $('#billingstatementreport').DataTable( {
				...
				/*3*/	{data: 'branch_initial', className: "text-left", orderable: false },
				/*4*/	{data: 'drivers_name', className: "text-left", orderable: false },
				/*5*/	{data: 'order_po_number', className: "text-left", orderable: false },		
				/*6*/	{data: 'plate_no', className: "text-left", orderable: false },	
				/*7*/	{data: 'product_name', className: "text-left", orderable: false },
				/*8*/	{data: 'order_quantity', className: "text-right", orderable: false, render: $.fn.dataTable.render.number( ',', '.', 2, '' ) },
				/*9*/		{data: 'product_unit_measurement', className: "text-center", orderable: false, render: $.fn.dataTable.render.number( ',', '.', 2, '' ) },
						// { data: null , 
							 // render : function ( data, type, full ) { 
								// return full['order_quantity']+' '+full['product_unit_measurement'];}, className: "text-right"
							  // },
				/*10*/	{data: 'product_price', className: "text-right", orderable: false, render: $.fn.dataTable.render.number( ',', '.', 2, '' ) },
				/*11*/	{data: 'order_total_amount', className: "text-right", orderable: false, render: $.fn.dataTable.render.number( ',', '.', 2 , '' ) },
