	...
	$(function () {
		...
		var getSOBillingTransactionList = $('#getSOBillingTransactionList').DataTable({
			...
			columns: [
					...
					{data: 'order_date', name: 'teves_billing_so_table.order_date', className: "text-center"},
					{data: 'order_time', name: 'teves_billing_so_table.order_time', orderable: false, className: "text-center"},
					{data: 'so_number', name: 'teves_billing_so_table.so_number', orderable: false, className: "text-left"},		
					{data: 'branch_code', name: 'teves_branch_table.branch_code', orderable: false, className: "text-center"},
					{data: 'client_name', name: 'teves_client_table.client_name', orderable: false},  
					{data: 'drivers_name', name: 'teves_billing_so_table.drivers_name', orderable: false, name: 'teves_billing_so_table.drivers_name'}, 
					{data: 'plate_no', name: 'teves_billing_so_table.plate_no', orderable: false},  		
