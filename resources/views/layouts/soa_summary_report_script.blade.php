				...
				get_client_details();
				  ...
				  if(response!='') {
					...
					// 'teves_receivable_table.receivable_amount'
							...
							var receivable_amount = response[i].order_time;
						...
						//	total_due += response[i].order_total_amount;
							...
							var tr_str = "<tr>" +
								...
								"<td align='center'>" + receivable_amount.toLocaleString("en-PH", {minimumFractionDigits: 2}) + "</td>" +
								"<td align='center'>" + receivable_remaining_balance.toLocaleString("en-PH", {minimumFractionDigits: 2}) + "</td>" +
								"</tr>";
