...
<body>
	...
	<table class="" width="100%" cellspacing="0" cellpadding="1">
		...
		<tr>
			...
			?>
			<td colspan="2" align="left" width="10%" style="font-size:12px; font-weight:bold; color:red;"><b>DATE</b></td>
			<td colspan="2" align="left" width="40%" style="font-size:12px; color:red; border-bottom:solid 1px gray;" class="td_colon"><?=$report_date;?></td>
		</tr>		
		...
		<tr>
			...
			<td colspan="2" align="left" width="10%" style="font-size:12px; font-weight:bold;;"><b>SHIFT</b></td>
			<td colspan="2" align="left" width="40%" style="font-size:12px; border-bottom:solid 1px gray;" class="td_colon">{{ $CashiersReportData[0]['shift'] }}</td>
		</tr>
