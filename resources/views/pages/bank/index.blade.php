...
@include('pages.bank.modals.bank_create_edit_modal')	
@include('pages.bank.modals.bank_delete_modal')	
...
@include('pages.bank.scripts.plugins_script')
@include('pages.bank.scripts.customized_script')
@include('pages.bank.scripts.bank_script')
