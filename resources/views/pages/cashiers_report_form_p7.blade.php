		...
		<div class="modal fade" id="Update_CRPH6_Modal" tabindex="-1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
					...
					<div class="modal-body">
						<form class="g-3 needs-validation" id="update_CRPH6_form">		
						
							<div class="row mb-2">
							<label for="update_product_idx_dipstick_inventory" class="col-sm-4 col-form-label">PRODUCT</label>
							<div class="col-sm-8">
									<input class="form-control" list="product_list_inventory" name="update_product_name_dipstick_inventory" id="update_product_idx_dipstick_inventory" required autocomplete="off" onchange="LoadProductTank_Update()">
