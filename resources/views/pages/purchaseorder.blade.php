					...
					<form class="g-2 needs-validation" id="PurchaseOrderformNew">		
								...
								<div class="row">
									<div class="col-md-6">
									  ...
									  <input type="number" class="form-control" id="purchase_order_net_percentage" name="purchase_order_net_percentage" step=".01">
									</div>
									
									<div class="col-md-6">
									  <label for="purchase_order_less_percentage" class="form-label">Less Value</label>
									  <input type="number" class="form-control" id="purchase_order_less_percentage" name="purchase_order_less_percentage" step=".01">
									</div>
								</div>
								<hr>								
								<div class="row">
								...
								<h6 class="modal-title">Hauler Details</h6>
									...
									<div class="col-md-3">
									  ...
									  <input type="text" class="form-control" id="purchase_driver" name="purchase_driver">
									</div>
									<div class="col-md-3">
									  <label for="purchase_lorry_plate_no" class="form-label">Lory Plate #</label>
									  <input type="date" class="form-control" id="purchase_lorry_plate_no" name="purchase_lorry_plate_no" value="<?=date('Y-m-d');?>">
									</div>
                  ...
                  <div class="modal-content">
					...
					<form class="g-2 needs-validation" id="purchaseOrderformUpdate">		
									...
									<div class="row">
										...
										<div class="col-md-3">
										  <label for="purchase_order_date" class="form-label">Date</label>
										  <input type="date" class="form-control" id="update_purchase_order_date" name="purchase_order_date" value="<?=date('Y-m-d');?>">
										</div>
									
										<div class="col-md-3">
										  <label for="purchase_supplier_name" class="form-label">Supplier's Name</label>
										  <input type="text" class="form-control" id="update_purchase_supplier_name" name="purchase_supplier_name" required >
										  <span class="valid-feedback" id="update_purchase_supplier_nameError"></span>
										</div>
										
										<div class="col-md-3">
										  <label for="purchase_supplier_tin" class="form-label" title="Supplier's Tax Identification">TIN</label>
										  <input type="text" class="form-control" id="update_purchase_supplier_tin" name="purchase_supplier_tin" >
										</div>
										
										<div class="col-md-3">
										  <label for="purchase_supplier_address" class="form-label">Address</label>
										  <input type="text" class="form-control" id="update_purchase_supplier_address" name="purchase_supplier_address">
										</div>	
								...
								<div class="row">
									...
									<div class="col-md-3">
										<label for="purchase_order_sales_order_number" class="form-label">Sales Order #</label>
										<input type="text" class="form-control" id="update_purchase_order_sales_order_number" name="purchase_order_sales_order_number">
										<span class="valid-feedback" id="update_purchase_order_sales_order_numberError"></span>
									</div>
									
									<div class="col-md-3">
									  <label for="purchase_order_collection_receipt_no" class="form-label">Collection Receipt #</label>
									  <input type="text" class="form-control" id="update_purchase_order_collection_receipt_no" name="purchase_order_collection_receipt_no">
									  <span class="valid-feedback" id="update_purchase_order_collection_receipt_noError"></span>
									</div>
									
									<div class="col-md-3">
									  <label for="purchase_order_official_receipt_no" class="form-label">Official Receipt #</label>
									  <input type="text" class="form-control" id="update_purchase_order_official_receipt_no" name="purchase_order_official_receipt_no">
									  <span class="valid-feedback" id="update_purchase_order_official_receipt_nooError"></span>
									</div>
										
									<div class="col-md-3">
									  <label for="purchase_order_delivery_receipt_no" class="form-label">Delivery Receipt #</label>
									  <input type="text" class="form-control" id="update_purchase_order_delivery_receipt_no" name="purchase_order_delivery_receipt_no">
								...
								<h6 class="modal-title">Payment Details</h6>
									...
									<div class="col-md-3">
									  <label for="purchase_order_bank" class="form-label">Bank</label>
									  <input type="text" class="form-control" id="update_purchase_order_bank" name="purchase_order_bank">
									</div>
									<div class="col-md-3">
									  <label for="purchase_order_date_of_payment" class="form-label">Date of Payment</label>
									  <input type="date" class="form-control" id="update_purchase_order_date_of_payment" name="purchase_order_date_of_payment" value="<?=date('Y-m-d');?>">
									</div>
									
									<div class="col-md-3">
									  <label for="purchase_order_reference_no" class="form-label">Reference No.</label>
									  <input type="text" class="form-control" id="update_purchase_order_reference_no" name="purchase_order_reference_no">
									</div>
									
									<div class="col-md-3">
									  <label for="purchase_order_payment_amount" class="form-label">Amount</label>
									  <input type="number" class="form-control" id="update_purchase_order_payment_amount" name="purchase_order_payment_amount">
									</div>
								...
								<h6 class="modal-title">Delivery Details</h6>
									<div class="col-md-3">
									  <label for="purchase_order_delivery_method" class="form-label">Delivery Method</label>
									  <input type="text" class="form-control" id="update_purchase_order_delivery_method" name="purchase_order_delivery_method">
									</div>
									
									<div class="col-md-3">
									  <label for="purchase_order_hauler" class="form-label">Hauler</label>
									  <input type="text" class="form-control" id="update_purchase_order_hauler" name="purchase_order_hauler" >
									</div>
									
									<div class="col-md-3">
									  <label for="purchase_order_date_of_pickup" class="form-label">Date of Pick-up</label>
									  <input type="date" class="form-control" id="update_purchase_order_date_of_pickup" name="purchase_order_date_of_pickup" value="<?=date('Y-m-d');?>">
									</div>
									
									<div class="col-md-3">
									  <label for="purchase_order_date_of_arrival" class="form-label">Date of Arrival</label>
									  <input type="date" class="form-control" id="update_purchase_order_date_of_arrival" name="purchase_order_date_of_arrival" value="<?=date('Y-m-d');?>">
									</div>
								...
								<div class="row">
									<div class="col-md-6">
									  <label for="purchase_order_net_percentage" class="form-label">Net Value</label>
									  <input type="number" class="form-control" id="update_purchase_order_net_percentage" name="purchase_order_net_percentage" step=".01">
									</div>
									
									<div class="col-md-6">
									  <label for="purchase_order_less_percentage" class="form-label">Less Value</label>
									  <input type="number" class="form-control" id="update_purchase_order_less_percentage" name="purchase_order_less_percentage" step=".01">
									</div>
								</div>
								<hr>								
								<div class="row">
								...
								<h6 class="modal-title">Hauler Details</h6>
									...
									<div class="col-md-3">
									  <label for="purchase_driver" class="form-label">Driver</label>
									  <input type="text" class="form-control" id="update_purchase_driver" name="purchase_driver">
									</div>
									<div class="col-md-3">
									  <label for="purchase_lorry_plate_no" class="form-label">Lory Plate #</label>
									  <input type="date" class="form-control" id="update_purchase_lorry_plate_no" name="purchase_lorry_plate_no" value="<?=date('Y-m-d');?>">
									</div>
									
									<div class="col-md-3">
									  <label for="purchase_loading_terminal" class="form-label">Loading Terminal</label>
									  <input type="text" class="form-control" id="update_purchase_loading_terminal" name="purchase_loading_terminal">
									</div>
									
									<div class="col-md-3">
									  <label for="purchase_terminal_address" class="form-label">Address</label>
									  <input type="number" class="form-control" id="update_purchase_terminal_address" name="purchase_terminal_address">
									</div>
								...
								<div class="row">
									...
									<div class="col-md-3">
									  <label for="purchase_destination" class="form-label">Destination</label>
									  <input type="text" class="form-control" id="update_purchase_destination" name="purchase_destination">
									</div>
									<div class="col-md-3">
									  <label for="purchase_destination_address" class="form-label">Address</label>
									  <input type="text" class="form-control" id="update_purchase_destination_address" name="purchase_destination_address" value="">
									</div>
									
									<div class="col-md-3">
									  <label for="purchase_date_of_departure" class="form-label">Date of Departure</label>
									  <input type="date" class="form-control" id="update_purchase_date_of_departure" name="purchase_date_of_departure">
									</div>
									
									<div class="col-md-3">
									  <label for="purchase_date_of_arrival" class="form-label">Date of Arrival</label>
									  <input type="date" class="form-control" id="update_purchase_date_of_arrival" name="purchase_date_of_arrival">
									</div>
								...
								<div class="row">
									...
									<div class="col-md-6">
									  <label for="purchase_order_instructions" class="form-label">Instructions</label>
									  <textarea class="form-control" id="update_purchase_order_instructions" name="purchase_order_instructions" style="height: 38px;"></textarea>
									</div>
									
									<div class="col-md-6">
									  <label for="purchase_order_note" class="form-label">Notes</label>
									  <textarea class="form-control" id="update_purchase_order_note" name="purchase_order_note" style="height: 38px;"></textarea>
									</div>
					...
					<div class="modal-footer modal-footer_form">		
						<button type="submit" class="btn btn-success btn-sm bi bi-save-fill navbar_icon" id="update-purchase-order"> Submit</button>
						<button type="reset" class="btn btn-primary btn-sm bi bi-backspace-fill navbar_icon"> Reset</button>
					</div>
					</form>		
                  </div>
