                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
					  ...
					  <div class="row mb-2">
						  ...
						  <div class="col-sm-8">
									<input class="form-control" list="product_list_dipstick_inventory" name="product_name_dipstick_inventory" id="product_idx_dipstick_inventory" required autocomplete="off" onchange="LoadProductTank_for_dipstick_inventory()">
						...
						<div class="row mb-2">
						  ...
						  <div class="col-sm-8">
									<input class="form-control" list="product_tank_list_dipstick_inventory" name="product_tank_name_dipstick_inventory" id="product_tank_idx_dipstick_inventory" required autocomplete="off">
						...
						<div class="row mb-2">
						  ...
						  <div class="col-sm-8">
							  <input type="number" class="form-control" placeholder="" aria-label="beginning_dipstick_inventory" aria-describedby="basic-addon1" name="beginning_dipstick_inventory" id="beginning_dipstick_inventory" required step=".01" onchange="dipstick_inventory_tank()" >
						...
						<div class="row mb-2">
						  ...
						  <div class="col-sm-8">
							  <input type="number" class="form-control" placeholder="" aria-label="sales_in_liters_dipstick_inventory" aria-describedby="basic-addon1" name="sales_in_liters_dipstick_inventory" id="sales_in_liters_dipstick_inventory" required step=".01" onchange="dipstick_inventory_tank()" >
						...
						<div class="row mb-2">
						  ...
						  <div class="col-sm-8">
							  <input type="number" class="form-control" placeholder="" aria-label="ugt_pumping_dipstick_inventory" aria-describedby="basic-addon1" name="ugt_pumping_dipstick_inventory" id="ugt_pumping_dipstick_inventory" required step=".01" onchange="dipstick_inventory_tank()" >
						...
						<div class="row mb-2">
						  ...
						  <div class="col-sm-8">
							  <input type="number" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="delivery_dipstick_inventory" id="delivery_dipstick_inventory" required step=".01" onchange="dipstick_inventory_tank()" >
						...
						<div class="row mb-2">
						  ...
						  <div class="col-sm-8">
							  <input type="number" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="ending_dipstick_inventory" id="ending_dipstick_inventory" required step=".01" onchange="dipstick_inventory_tank()" >
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
					  ...
					  <div class="row mb-2">
						  ...
						  <div class="col-sm-8">
									<input class="form-control" list="product_list_dipstick_inventory" name="update_product_name_dipstick_inventory" id="update_product_idx_dipstick_inventory" required autocomplete="off" onchange="LoadProductTank_Update()">
						...
						<div class="row mb-2">
						  ...
						  <div class="col-sm-8">
									<input class="form-control" list="update_product_tank_list" name="update_product_tank_dipstick_inventory" id="update_product_tank_idx_dipstick_inventory" required autocomplete="off">
						...
						<div class="row mb-2">
						  <label for="beginning_reading_dipstick_inventory" class="col-sm-4 col-form-label">BEGINNING INVENTORY</label>
						  <div class="col-sm-8">
							  <input type="number" class="form-control" placeholder="" aria-label="update_beginning_dipstick_inventory" aria-describedby="basic-addon1" name="update_beginning_dipstick_inventory" id="update_beginning_dipstick_inventory" required step=".01" onchange="update_dipstick_dipstick_inventory_tank()" >
						...
						<div class="row mb-2">
						  ...
						  <div class="col-sm-8">
							  <input type="number" class="form-control" placeholder="" aria-label="update_sales_in_liters_dipstick_inventory" aria-describedby="basic-addon1" name="update_sales_in_liters_dipstick_inventory" id="update_sales_in_liters_dipstick_inventory" required step=".01" onchange="update_dipstick_dipstick_inventory_tank()" >
						...
						<div class="row mb-2">
						  ...
						  <div class="col-sm-8">
							  <input type="number" class="form-control" placeholder="" aria-label="update_delivery_dipstick_inventory" aria-describedby="basic-addon1" name="update_delivery_dipstick_inventory" id="update_delivery_dipstick_inventory" required step=".01" onchange="update_dipstick_dipstick_inventory_tank()" >
						...
						<div class="row mb-2">
						  ...
						  <div class="col-sm-8">
							  <input type="number" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="update_ending_dipstick_inventory" id="update_ending_dipstick_inventory" required step=".01" onchange="update_dipstick_dipstick_inventory_tank()" >
