				...
				<div class="p-d3">
						...
						<div class="card-body">
						  ...
						  <div class="tab-content pt-2" id="myTabjustifiedContent">
							...
							<div align="right">
								<button type="button" class="btn btn-success new_item bi bi-cart-plus-fill" onclick="AddProductOtherSalesRow();" title="Add a Product(1-5 items)"></button>
								</div>
								<br>
								
								<table class="table" id="table_product_data_other_sales">
                    ...
                    <div class="text-center">				
						  <button type="submit" class="btn btn-success btn-sm bi bi-save-fill navbar_icon" id="save-cashiers-report2"> Submit</button>
