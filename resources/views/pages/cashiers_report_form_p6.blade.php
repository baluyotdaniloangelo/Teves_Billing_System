	...
	<div class="row mb-2">
		...
		<table class="table" width="100%">
                <thead>
                  <tr>
                    <th scope="col" style="text-align: center !important;" colspan="2">SUMMARY</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <th scope="row">FUEL SALES</th>
                    <td style="text-align: right !important;"><span id="fuel_sales_total">0.00</span></td>
                  </tr>
                   <tr>
