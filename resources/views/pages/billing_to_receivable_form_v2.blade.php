		...
		<div class="card">
            ...
            <div class="card-body">
					 ...
					 <!-- Default Tabs -->
					  <ul class="nav nav-tabs" id="myTab" role="tablist">
						...
						<li class="nav-item" role="presentation">
						  <button class="nav-link <?php if($tab=='information') { echo 'active'; } ?>" id="information-tab" data-bs-toggle="tab" data-bs-target="#information" type="button" role="tab" aria-controls="information" aria-selected="true" title='View/Edit Receivable Information'>Information</button>
						</li>
              ...
              <div class="tab-content pt-2" id="myTabContent">
				...
				<div class="tab-pane fade  <?php if($tab=='information') { echo ' show active'; } ?>"" id="information" role="tabpanel" aria-labelledby="information-tab">
					
						<ul class="list-group list-group-flush">
							<li class="list-group-item"><b>Sold To:</b>&nbsp;<span id="client_name_information" style="font-weight: normal;"></span></li>
							<li class="list-group-item"><b>Branch:</b>&nbsp;<span id="branch_information" style="font-weight: normal;"></span></li>
							<li class="list-group-item"><b>Date:</b>&nbsp;<span id="date_information" style="font-weight: normal;"></span></li>
							<li class="list-group-item"><b>Time:</b>&nbsp;<span id="time_information" style="font-weight: normal;"></span></li>
							<li class="list-group-item"><b>Period:</b>&nbsp;<span id="period_information" style="font-weight: normal;"></span></li>
							<li class="list-group-item"><b>Discount Per Liter:</b>&nbsp;<span id="discount_information" style="font-weight: normal;"></span></li>
							<li class="list-group-item"><b>Net Value:</b>&nbsp;<span id="net_value_information" style="font-weight: normal;"></span></li>
							<li class="list-group-item"><b>VAT Value:</b>&nbsp;<span id="vat_value_information" style="font-weight: normal;"></span></li>
							<li class="list-group-item"><b>Withholding Tax:</b>&nbsp;<span id="withholding_tax_value_information" style="font-weight: normal;"></span></li>
							<li class="list-group-item"><b>Payment Term:</b>&nbsp;<span id="payment_term_information" style="font-weight: normal;"></span></li>
							<li class="list-group-item"><b>Description:</b>&nbsp;<span id="description_information" style="font-weight: normal;"></span></li>
							<li class="list-group-item"><b>Amount:</b>&nbsp;<span id="amount_information" style="font-weight: normal;"></span></li>
