...
<body>
	...
	<table class="" width="100%" cellspacing="0" cellpadding="1">
		...
		<tr>
			<td colspan="11" style="border-left:0px solid #000;border-right:0px solid #000;border-bottom:0px solid #000;">&nbsp;</td>
		</tr>
		
		<tr style="font-size:12px;border:0 solid #000;">
			<td colspan="11" nowrap align="center" style="border:0px solid gray; background-color: #c6e0b4; font-weight:bold; height:10px !important; "></td>
		</tr>
		...
		<tr style="font-size:12px;border:0 solid #000;">
			...
			<th style="border-right:1px solid skyblue;  background-color: #c6e0b4; font-weight:bold; height:25px !important; padding:10px;">S.O. No.</th>
			<th style="border-right:1px solid skyblue;  background-color: #c6e0b4; font-weight:bold; height:25px !important; padding:10px; "width="20%">Account Name</th>
			<th align="left" style="border-right:1px solid skyblue; background-color: #c6e0b4; font-weight:bold; padding:10px;">Payment Term</th>
			<th align="right" style="border-right:1px solid skyblue; background-color: #c6e0b4; font-weight:bold; padding:10px;">Gross Amount</th>
			...
			<th align="right" style="border-right:1px solid skyblue; background-color: #c6e0b4; font-weight:bold; padding:10px;">Total Due</th>
		...
		<tr style="font-size:12px;">
			...
			<td colspan="1" align="left" style="border-left:0px solid #000; border-bottom:solid 1px gray; padding:10px;"><?=$sales_order_date;?></td>
			<td colspan="1" align="left" style="border-left:0px solid #000; border-bottom:solid 1px gray; padding:10px;">{{ $sales_order_data_data_cols['sales_order_control_number'] }}</td>
			<td colspan="1" align="left"  style="border-left:0px solid #000; border-bottom:solid 1px gray; padding:10px;">{{ $sales_order_data_data_cols['client_name'] }}</td>
			<td colspan="1" align="left" style="border-left:0px solid #000; border-right:0px solid #000; border-bottom:solid 1px gray;"><?=$sales_order_data_data_cols['sales_order_payment_term'];?></td>	
			<td colspan="1" align="right" style="border-left:0px solid #000; border-right:0px solid #000; border-bottom:solid 1px gray;"><?=number_format($sales_order_data_data_cols['sales_order_gross_amount'],2);?></td>			
			<td colspan="1" align="right" style="border-left:0px solid #000; border-right:0px solid #000; border-bottom:solid 1px gray;"><?=number_format($sales_order_withholding_tax);?></td>			
			<td colspan="1" align="right" style="border-left:0px solid #000; border-right:0px solid #000; border-bottom:solid 1px gray;"><?=number_format($sales_order_data_data_cols['sales_order_net_amount'],2);?></td>			
			<td colspan="1" align="right" style="border-left:0px solid #000; border-right:0px solid #000; border-bottom:solid 1px gray;"><?=number_format($sales_order_data_data_cols['sales_order_total_due'],2);?></td>			
			<td colspan="1" align="center" style="border-left:0px solid #000; border-right:0px solid #000; border-bottom:solid 1px gray;"><?=$sales_order_data_data_cols['sales_order_delivery_status'];?></td>			
			<td colspan="1" align="center" style="border-left:0px solid #000; border-right:0px solid #000; border-bottom:solid 1px gray;"><?=$sales_order_data_data_cols['sales_order_payment_status'];?></td>			
