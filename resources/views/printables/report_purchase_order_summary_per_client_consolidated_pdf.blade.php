...
<body>
	...
	<table class="" width="100%" cellspacing="0" cellpadding="1">
		...
		<tr style="font-size:12px;border:0 solid #000;">
			...
			<th style="border:1px solid skyblue; background-color: #c6e0b4; font-weight:bold; height:25px !important; padding:10px;" width="15%">Year - Month</th>
		...
		@foreach ($purchase_order_data as $purchase_order_data_data_cols)
			<?php
				...
				//$purchase_order_less_percentage = $purchase_order_data_data_cols['total_net_amount'] * $purchase_order_data_data_cols['total_less_percentage']/100;
	...
	<table class="" width="100%" cellspacing="0" cellpadding="1">
		...
		<tr>
			<td colspan="6" style="border-left:0px solid #000;border-right:0px solid #000;border-bottom:0px solid #000;">&nbsp;</td>
		</tr>
		...
		@foreach ($purchase_order_without_withholding_tax_data as $purchase_order_without_withholding_data_cols)
			<?php
				...
				$purchase_order_date_without_withholding = strtoupper(date_format($_purchase_order_date_without_withholding,"Y - F"));
		...
		<tr>
			<td colspan="6" style="height:5.66px !important;"></td>
		</tr>
