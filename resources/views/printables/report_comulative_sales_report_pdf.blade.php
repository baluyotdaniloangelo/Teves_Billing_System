	...
	<table class="" width="100%" cellspacing="0" cellpadding="1" >
		...
		<table class="" width="100%" cellspacing="0" cellpadding="1" >
			...
			<tr>
				...
				<th class="data_th" nowrap style="border:1px solid #000;" align="right">OPENING STOCK</th>
				<th class="data_th" nowrap style="border:1px solid #000;" align="right">STOCK DELIVERIES</th>
				<th class="data_th" nowrap style="border:1px solid #000;" align="right">SALES</th>
				<th class="data_th" nowrap style="border:1px solid #000;" align="right">BOOK STOCK</th>
				<th class="data_th" nowrap style="border:1px solid #000;" align="right">CLOSING STOCK</th>
				<th class="data_th" nowrap style="border:1px solid #000;" align="right">VARIANCE</th>
				<th class="data_th" nowrap style="border:1px solid #000;" align="right">CUMULATIVE VARIANCE</th>
				<th class="data_th" nowrap style="border:1px solid #000;" align="right">CUMULATIVE SALES</th>
